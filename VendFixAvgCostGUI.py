...
class VendFixAvgCostGUI:
    ...
    def __loadUserInputs__(self, mainFrame):
        ...
        lblTicket = Label(mainFrame, text="Ticket #:", font="Helvetica 14 bold")
        lblTicket.grid(row=2, column=0, sticky=E)
    ...
    def __loadCsvControl__(self, mainFrame):
        ...
        self.csvListbox.grid(row=0, column=2, rowspan=4, padx=10, pady=5)
    ...
    def setTicketNum(self, ticknum):
        self.txtTicketNum.delete(0, END)
        self.txtTicketNum.insert(0, ticknum)
